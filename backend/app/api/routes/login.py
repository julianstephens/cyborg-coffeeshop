...
def test_token(
    ...
    scopes: Annotated[str, Security(get_scopes)],
) -> Any:
    """
    Test access token
    """
    return {"user": UserPublic(**current_user.model_dump()), "scopes": scopes}
...
@router.post(
    ...
    dependencies=[Security(get_current_user, scopes=["user:me:password:write"])],
